...
{
    /// <summary>
    /// OutlineColorの時間グラデーションアニメーション
    /// </summary>
    [Serializable]
    public class TMPM_OutlineColorTimeGradientAnimation : MatAnimationBase
    {
        /// <summary>
        /// マテリアルのパラメータID
        /// </summary>
        private int matParamId = Shader.PropertyToID("_OutlineColor");
