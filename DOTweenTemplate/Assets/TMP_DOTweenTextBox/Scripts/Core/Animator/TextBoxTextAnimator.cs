...
namespace TMP_DOTweenTextBox.Core.Animator
{
    ...
    public class TextBoxTextAnimator : MonoBehaviour
    {
        ...
        private (bool isExist,TextBox.TMP_DOTweenTextBox textBox) IsExistTextBox()
        {
            var textBox = GetComponent<TextBox.TMP_DOTweenTextBox>();
        ...
        private void PresenterSetting(TextBox.TMP_DOTweenTextBox textBox) => textBoxTextAnimatorPresenter = new TextBoxTextAnimatorPresenter(textBox,this);
